...
include_once('../../../public/config.php');
  ...
  if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
    ...
    if($Descricao==""){
      ...
      $userCount	=	$db->getQueryCount('patologia','idPatologia'); //users eh a tabela
      $data	=	array(
      ...
      if($insert){
        header('location: ../read/patologia.blade.php?msg=radd'); //add com sucesso
        exit;
      }else{
        header('location: ../read/patologia.blade.php?msg=rerr'); // nao adicionado
        exit;
      }
    }
  }
