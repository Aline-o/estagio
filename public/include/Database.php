...
class Database{
    ...
    {
        //nessa função existe um '1' depois do WHERE
    ...
    {
        //SELECT escola.NomeEscola, modalidadeensino.NomeModalidadelEnsino FROM escola, modalidadeensino WHERE escola.ModalidaEnsino_idModalidadeEnsino = modalidadeensino.idModalidadeEnsino");
